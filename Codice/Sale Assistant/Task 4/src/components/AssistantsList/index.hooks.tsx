...
import { AssistantStateChipDialog } from "@/components/AssistantStateChipDialog";
...
export const useAssistantsList = (
  ...
  const onChipDialogOpen = useCallback(() => {
    dispatch(
      actions.setDialogOpen({
        ...
        return (
          <>
            <Chip
              ...
              color="default"
              variant="filled"
              onClick={onChipDialogOpen}
            />
            <AssistantStateChipDialog status={status} />
          </>
        );
